class StatementDetailModel {
  bool? success;
  StatementDetailData? data;
  String? message;
  int? code;

  StatementDetailModel({this.success, this.data, this.message, this.code});

  StatementDetailModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = json['data'] != null ? StatementDetailData.fromJson(json['data']) : null;
...
class StatementDetailData {
  ...
  StatementDetailData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
